 ...
 * 3. Avoids redundant paths by eliminating excessive loops (e.g.,double self consecutive loops, triple consecutive loops).
 * 4. Converts combinatorial transitions (e.g., IDs starting with "c") into sequential transitions IDs
...
public class CycleGeneratorAlgorithm implements CycleGeneratorStrategy{
 ...
 - Ensures no redundant loops are included in the generated paths.
    */
     ...
     * after itself (e.g., [S1, T1, S1, T1, S1]).
     *
