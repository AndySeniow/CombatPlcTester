...
public class TestController {
    ...
    *   - **Initial Value**: Validates based on the input type (e.g., BIT, BYTE, WORD, etc.).
    ...
    *   - **Start Address**: Validates as a non-negative value.
    *   - **Bit Address** (for BIT type): Checks that the value is between 0 and 7.
    *   - **Initial Value**: Validates based on the output's PLC data type (e.g., BIT, BYTE, WORD, etc.).
    ...
    * @param plcdatatype The PLC data type of the output (e.g., BIT, BYTE, WORD).
    ...
    *    - **Initial Value**: Validates based on the output type (e.g., BIT, BYTE, WORD, etc.).
    ...
    *    - For other types (e.g., `InputByte`, `InputWord`, etc.), ensures the value falls within the valid range.
    ...
    *    - For other input types (e.g., `InputByte`, `InputWord`), checks that the value falls within valid ranges.
    ...
    *        - Waits between state and transition tests using the cycle time and scaling factor.
