...
/**
 * Class: AddCombinatorialTransitionCommand
 * 
 * Purpose:
 * Implements the `Command` interface to encapsulate the process of adding a combinatorial transition
 ...
 * @since 13/01/2025
 */
public class AddCombinatorialTransitionCommand implements Command{   
    ...
    /**
    * Constructor for the AddCombinatorialTransitionCommand.
    * 
    * Initializes the command with necessary parameters to add a combinatorial transition
    ...
    */
    public AddCombinatorialTransitionCommand(TestController testcontroller, String startStateID, String endStateId, double startX, double startY, 
    ...
    */
    @Override
    public void execute(){
        transition = testcontroller.addCombinatorialTransition(startStateID, endStateID, startX, startY, 
    ...
    /**
    * Redoes the addition of the combinatorial transition without any inputs or sequential transitions.
    * 
    * This method ensures that all inputs and sequential transitions associated with the transition 
    * are cleared before re-adding it to the test controller. It iterates through the input and 
    * sequential transition lists, removing all elements to ensure the transition is added in a 
    * clean state.
    */
    @Override
    public void redo() {       
